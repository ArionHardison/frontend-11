						...
						<div class="card text-center doctor-book-card">
							...
							<div class="doctor-book-card-content tile-card-content-1">
								<div>
									...
									<NuxtLink to="/search" class="btn book-btn1 px-3 py-2 mt-3 btn-one-light" tabindex="0">Book Now</NuxtLink>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card text-center doctor-book-card">
							...
							<div class="doctor-book-card-content tile-card-content-1">
								<div>
									...
									<NuxtLink to="/pharmacy-search" class="btn book-btn1 px-3 py-2 mt-3 btn-one-light" tabindex="0">Find Now</NuxtLink>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="col-lg-8">
				<div class="doctor-slider slider aos" data-aos="fade-up">
					...
					<div class="profile-widget">
						...
						<div class="pro-content">
							<h3 class="title">
								<NuxtLink to="/doctor-profile">Darren Elder</NuxtLink> 
								<i class="fas fa-check-circle verified"></i>
							</h3>
					...
					<div class="profile-widget">
						...
						<div class="pro-content">
							<h3 class="title">
								<NuxtLink to="/doctor-profile">Deborah Angel</NuxtLink> 
								<i class="fas fa-check-circle verified"></i>
							</h3>
					...
					<div class="profile-widget">
						...
						<div class="pro-content">
							<h3 class="title">
								<NuxtLink to="/doctor-profile">Sofia Brient</NuxtLink> 
								<i class="fas fa-check-circle verified"></i>
							</h3>
					...
					<div class="profile-widget">
						...
						<div class="pro-content">
							<h3 class="title">
								<NuxtLink to="/doctor-profile">Marvin Campbell</NuxtLink> 
								<i class="fas fa-check-circle verified"></i>
							</h3>
					...
					<div class="profile-widget">
						...
						<div class="pro-content">
							<h3 class="title">
								<NuxtLink to="/doctor-profile">Katharine Berthold</NuxtLink> 
								<i class="fas fa-check-circle verified"></i>
							</h3>
					...
					<div class="profile-widget">
						...
						<div class="pro-content">
							<h3 class="title">
								<NuxtLink to="/doctor-profile">Linda Tobin</NuxtLink> 
								<i class="fas fa-check-circle verified"></i>
							</h3>
					...
					<div class="profile-widget">
						...
						<div class="pro-content">
							<h3 class="title">
								<NuxtLink to="/doctor-profile">Paul Richard</NuxtLink> 
								<i class="fas fa-check-circle verified"></i>
							</h3>
...
<section class="section section-blogs">
	<div class="container-fluid">
		...
		<div class="view-all text-center aos" data-aos="fade-up"> 
			<NuxtLink to="/blog-list" class="btn btn-primary">View All</NuxtLink>
		</div>
	</div>
</section>
<!-- /Blog Section -->	
