                        ...
                        <div class="doctor-widget">
                            <div class="doc-info-left">
                                <div class="doctor-img1">
                                    <NuxtLink to="/pharmacy-details">
                                        <img src="../assets/img/medical-img1.jpg" class="img-fluid" alt="User Image">
                                    </NuxtLink>
                                </div>
                                <div class="doc-info-cont">
                                    <h4 class="doc-name mb-2"><NuxtLink to="/pharmacy-details">Medlife Medical</NuxtLink></h4>
                            ...
                            <div class="doc-info-right">
                                <div class="clinic-booking">
                                    <NuxtLink class="view-pro-btn" to="/pharmacy-details">View Details</NuxtLink>
                                    <NuxtLink class="apt-btn" to="/product-all">Browse Products</NuxtLink>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="doctor-widget">
                            <div class="doc-info-left">
                                ...
                                <div class="doc-info-cont">
                                    <h4 class="doc-name mb-2"><NuxtLink to="/pharmacy-details">PharmaMed Medical</NuxtLink></h4>
                                    <div class="rating mb-2">
                                        <span class="badge badge-primary">4.0</span>
                                        <i class="fas fa-star filled"></i>
                                        <i class="fas fa-star filled"></i>
                    ...
                    <div class="card-body">
                        <div class="doctor-widget">
                            <div class="doc-info-left">
                                ...
                                <div class="doc-info-cont">
                                    <h4 class="doc-name mb-2"><NuxtLink to="/pharmacy-details">The Pill Club Medical</NuxtLink></h4>
                                    <div class="rating mb-2">
                                        <span class="badge badge-primary">4.0</span>
                                        <i class="fas fa-star filled"></i>
                                        <i class="fas fa-star filled"></i>
                                    ...
                                    <div class="clinic-details">
                                        ...
                                        <p class="doc-location mb-2"><i class="fas fa-phone-volume me-1"></i> 816-270-2336</p>
                                        <p class="doc-location mb-2 text-ellipse"><i class="fas fa-map-marker-alt me-1"></i> 3849 Nutter Street Ferrelview, MO 64163 </p>
                                        <p class="doc-location mb-2"><i class="fas fa-chevron-right me-1"></i> Chemists, Surgical Equipment Dealer</p>
