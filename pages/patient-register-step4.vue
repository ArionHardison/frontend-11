                                ...
                                <form method="post" id="famil_age">
                                    ...
                                    <div class="step-process-col mt-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control patient-file" id="Child_1_image" name="Child_1_image">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control patient-file" id="spouse_file" name="spouse_file">
                                        </div>
                                        <div class="form-group">
                                            <label>Father</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control patient-file" id="father_file" name="father_file">
                                        </div>
                                        <div class="form-group">
                                            <label>Mother</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control patient-file" id="mother_file" name="mother_file">
                                        </div>
                                    </div>
                                    <div class="mt-5">
                                        <NuxtLink to="/patient-dashboard" class="btn btn-primary w-100 btn-lg login-btn step4_submit">continue </NuxtLink>
                                    </div>
                                </form>
                            </div>
                        </div>
