                                ...
                                <div class="navbar">
                                    <div class="user-details">
                                        <div class="float-start user-img">
                                            <NuxtLink class="avatar avatar-sm me-2" to="/patient-profile" title="Charlene Reed">
                                                <img src="../assets/img/patients/patient1.jpg" alt="User Image" class="rounded-circle">
                                                <span class="status online"></span>
                                            </NuxtLink>
                                        </div>
                                        <div class="user-info float-start">
                                            <NuxtLink to="/patient-profile"><span>Charlene Reed</span></NuxtLink>
