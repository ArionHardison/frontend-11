        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="booking-doc-info">
                            <NuxtLink to="/doctor-profile" class="booking-doc-img">
                                <img src="../assets/img/doctors/doctor-thumb-02.jpg" alt="User Image">
                            </NuxtLink>
                            <div class="booking-info">
                                <h4><NuxtLink to="/doctor-profile">Dr. Darren Elder</NuxtLink></h4>
                                <div class="rating">
                ...
                <div class="submit-section proceed-btn text-end">
                    <NuxtLink to="/checkout" class="btn btn-primary submit-btn">Proceed to Pay</NuxtLink>
                </div>
                <!-- /Submit Section -->
