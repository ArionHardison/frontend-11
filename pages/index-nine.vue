                        ...
                        <div class="doctor-form aos" data-aos="fade-up">
                            <form action="#" class="doctor-search-form">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <NuxtLink to="/search" class="btn banner-btn mt-3">MAKE APPOINTMENT</NuxtLink>
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                <div class="visit-doctor aos" data-aos="fade-up">
                    <div class="inner-details">
                        ...
                        <div class="info">
                            ...
                            <NuxtLink to="/booking">Book Now <i class="fas fa-long-arrow-alt-right"></i> </NuxtLink>
                        </div>
    ...
    <div class="container">
        <div class="row heading-wrapper">
            ...
            <div class="col-md-6 text-end aos" data-aos="fade-up">
                <NuxtLink to="/doctor-profile" class="nav-arrow"><i class="fas fa-arrow-right"></i></NuxtLink>
            </div>
        </div>
        <div class="row">
...
<section class="doctor-divison provider-select">
    <div class="d-flex">
        <div class="doc-background aos" data-aos="fade-up">
            ...
            <NuxtLink to="/booking" class="doc-bok-btn">Book Now</NuxtLink>
        </div>
...
<section class="blogs-section blog-container">
    <div class="container">	
        <div class="row heading-wrapper">
            ...
            <div class="col-md-6 text-end aos" data-aos="fade-up">
                <NuxtLink to="/blog-list" class="nav-arrow"><i class="fas fa-arrow-right"></i></NuxtLink>
            </div>
        </div>		
        <div class="row">						
