                    ...
                    <div class="row align-items-center justify-content-center">
                        ...
                        <div class="col-md-12 col-lg-6 login-right">
                            <div class="login-header">
                                <h3>Pharmacy Register <NuxtLink to="/doctor-register">Are you a Doctor?</NuxtLink></h3>
                            </div>
                            ...
                            <form>
                                ...
                                <div class="text-end">
                                    <NuxtLink class="forgot-link" to="/login">Already have an account?</NuxtLink>
                                </div>
                                <NuxtLink to="/pharmacy-register-step1">
