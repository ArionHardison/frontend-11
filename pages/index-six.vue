                        ...
                        <div class="card text-center doctor-book-card aos" data-aos="fade-up">
                            ...
                            <div class="doctor-book-card-content tile-card-content-1">
                                <div>
                                    ...
                                    <NuxtLink to="/search" class="btn book-btn1 px-3 py-2 mt-3" tabindex="0">Book Now</NuxtLink>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card text-center doctor-book-card aos" data-aos="fade-up">
                            ...
                            <div class="doctor-book-card-content tile-card-content-1">
                                <div>
                                    ...
                                    <NuxtLink to="/pharmacy-search" class="btn book-btn1 px-3 py-2 mt-3" tabindex="0">Find Now</NuxtLink>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="blog grid-blog aos" data-aos="fade-up">
                    ...
                    <div class="blog-content">
                        <ul class="entry-meta meta-item">
                            <li>
                                <div class="post-author">
                                    <NuxtLink to="/blog-details"><img src="../assets/img/doctors/doctor-thumb-03.jpg" alt="Post Author"> <span>Dr. Deborah Angel</span></NuxtLink>
                                </div>
                            </li>
                            <li><i class="far fa-clock"></i> 3 Dec 2019</li>
                        </ul>
