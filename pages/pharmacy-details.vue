                ...
                <div class="doctor-widget">
                    ...
                    <div class="doc-info-right d-flex align-items-center justify-content-center">
                        <div class="clinic-booking">
                            <NuxtLink class="view-pro-btn" to="/chat">Send Message</NuxtLink>
                            <a class="apt-btn" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#voice_call">Call Now</a>
                            <NuxtLink to="/product-all" class="view-pro-btn">Browse Products</NuxtLink>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="call-wrapper">
                        <div class="call-inner">
                            ...
                            <div class="call-items">
                                ...
                                <NuxtLink to="/voice-call" class="btn call-item call-start"><i class="material-icons">call</i></NuxtLink>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="call-box incoming-box">
                    <div class="call-wrapper">
                        <div class="call-inner">
                            ...
                            <div class="call-items">
                                <a href="javascript:void(0);" class="btn call-item call-end" data-bs-dismiss="modal" aria-label="Close"><i class="material-icons">call_end</i></a>
                                <NuxtLink to="/video-call" class="btn call-item call-start"><i class="material-icons">videocam</i></NuxtLink>
                            </div>
                        </div>
                    </div>
                </div>
