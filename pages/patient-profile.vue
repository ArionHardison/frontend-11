								...
								<div class="card-body pt-0">
									...
									<div class="tab-content">
														...
														<table class="table table-hover table-center mb-0">
															...
															<tbody>
																...
																<tr>
																	...
																	<td class="text-end">
																		<div class="table-action">
																			<NuxtLink to="/edit-prescription" class="btn btn-sm bg-success-light">
																				<i class="far fa-edit"></i> Edit
                                                                            </NuxtLink>
										...
										<div class="tab-pane fade" id="pres">
											<div class="text-end">
												<NuxtLink to="/add-prescription" class="add-new-btn">Add Prescription</NuxtLink>
											</div>
											<div class="card card-table mb-0">
												<div class="card-body">
													<div class="table-responsive">
										...
										<div class="tab-pane fade" id="medical">
											<div class="text-end">		
												<a href="javascript:void(0);" class="add-new-btn" data-bs-toggle="modal" data-bs-target="#add_medical_records">Add Medical Records</a>
											</div>
											<div class="card card-table mb-0">
												<div class="card-body">
													<div class="table-responsive">
																...
																<tr>
																	...
																	<td class="text-end">
																		<div class="table-action">
																			...
																			<NuxtLink to="/edit-prescription" class="btn btn-sm bg-success-light" data-bs-toggle="modal" data-bs-target="#add_medical_records">
																				<i class="fas fa-edit"></i> Edit
                                                                            </NuxtLink>
																			<a href="javascript:void(0);" class="btn btn-sm bg-danger-light">
																				<i class="far fa-trash-alt"></i> Delete
										...
										<div class="tab-pane" id="billing">
											<div class="text-end">
												<NuxtLink class="add-new-btn" to="/add-billing">Add Billing</NuxtLink>
											</div>
											<div class="card card-table mb-0">
												<div class="card-body">
													<div class="table-responsive">
																...
																<tr>
																	...
																	<td class="text-end">
																		<div class="table-action">
																			...
																			<NuxtLink to="/edit-billing" class="btn btn-sm bg-success-light">
																				<i class="fas fa-edit"></i> Edit
                                                                            </NuxtLink>
																			<a href="javascript:void(0);" class="btn btn-sm bg-danger-light">
																				<i class="far fa-trash-alt"></i> Delete
