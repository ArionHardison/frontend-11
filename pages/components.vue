						...
						<section class="comp-section">
                            ...
                            <div class="card">
                            	...
                            	<div class="card-body">
				                    ...
				                    <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#exampleModalLong" data-original-title="" title="">Scrolling long content</button>
				                    <!-- Vertically centered modal-->
				                    <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#exampleModalCenter" data-original-title="" title="">Vertically centered</button>
				                    <!-- Tooltips and popovers modal-->
				                    <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#tooltipmodal" data-original-title="" title="">Tooltips and popovers</button>
				                    <!-- Using the grid modal-->
				                    <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#grid-modal" data-original-title="" title="">Using the grid</button>
				                </div>
                            </div>
                            ...
                            <div class="card">
                            	...
                            	<div class="card-body btn-showcase">
			                    	<button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#exampleModalfat" data-whatever="@mdo" data-original-title="" title="">Open modal for @mdo</button>
			                    	<button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#exampleModalmdo" data-whatever="@fat" data-original-title="" title="">Open modal for @fat</button>
			                    	<button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#exampleModalgetbootstrap" data-whatever="@getbootstrap" data-original-title="" title="">Open modal for @getbootstrap</button>
			                  </div>
                            </div>
                            ...
                            <div class="card">
								...
								<div class="card-body">
				                    ...
				                    <!-- Large modal-->
				                    <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target=".bd-example-modal-lg" data-original-title="" title="">Large modal</button>
				                    	
				                    <!-- Small modal-->
				                    <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target=".bd-example-modal-sm" data-original-title="" title="">Small modal</button>
			                  	</div>
							</div>
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                    ...
                    <p>This <a class="btn btn-primary popover-test" href="javascript:void(0);" role="button" title="Popover title" data-bs-toggle="popover" data-bs-content="Popover body content is set in this attribute." data-bs-original-title="Popover title">button</a> triggers a popover on click.</p>
                    <hr>
                    <h5>Tooltips in a modal</h5>
                    <p><a class="tooltip-test" href="javascript:void(0);" title="" data-bs-original-title="Tooltip" data-bs-toggle="popover" data-bs-placement="bottom" data-bs-trigger="hover focus">This link</a> and <a class="tooltip-test" href="javascript:void(0);" title="" data-bs-trigger="hover focus" data-bs-placement="bottom" data-bs-toggle="popover" data-bs-original-title="Tooltip">that link</a> have tooltips on hover.</p>
                  </div>
                  <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-bs-dismiss="modal" data-original-title="" title="">Close</button>
                    <button class="btn btn-primary" type="button" data-original-title="" title="">Save changes</button>
