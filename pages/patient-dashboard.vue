<template>
								...
								<div class="dashboard-widget">
									<nav class="dashboard-menu">
										<ul>
											...
											<li>
												<NuxtLink to="/patient-accounts">
													<i class="fas fa-file-invoice-dollar"></i>
													<span>Accounts</span>
                                                </NuxtLink>
											</li>
											<li>
												<NuxtLink to="/orders-list">
										...
										<div class="card-body pt-2 pb-2 mt-1 mb-1">
											<div class="row">
												<div class="col-12 col-md-6 col-lg-4 col-xl-3 patient-graph-box">
													<a href="javascript:void(0);" class="graph-box" data-bs-toggle="modal" data-bs-target="#graph1">
														<div>
															<h4>BMI Status</h4>
														</div>
														<div class="graph-img">
												...
												<div class="col-12 col-md-6 col-lg-4 col-xl-3 patient-graph-box">
														<a href="javascript:void(0);" class="graph-box pink-graph" data-bs-toggle="modal" data-bs-target="#graph2">
															<div>
												...
												<div class="col-12 col-md-6 col-lg-4 col-xl-3 patient-graph-box">
													<a href="javascript:void(0);" class="graph-box sky-blue-graph" data-bs-toggle="modal" data-bs-target="#graph3">
														<div>
															<h4>FBC Status</h4>
														</div>
														<div class="graph-img">
												...
												<div class="col-12 col-md-6 col-lg-4 col-xl-3 patient-graph-box">
													<a href="javascript:void(0);" class="graph-box orange-graph" data-bs-toggle="modal" data-bs-target="#graph4">
														<div>
															<h4>Weight Status</h4>
														</div>
														<div class="graph-img">
																...
																<tr>
																	<td>
																		<h2 class="table-avatar">
																			<NuxtLink to="/doctor-profile" class="avatar avatar-sm me-2">
																				<img class="avatar-img rounded-circle" src="../assets/img/doctors/doctor-thumb-01.jpg" alt="User Image">
                                                                            </NuxtLink>
																			<NuxtLink to="/doctor-profile">Dr. Ruby Perrin <span>Dental</span></NuxtLink>
																		</h2>
																	</td>
																...
																<tr>
																	<td>
																		<h2 class="table-avatar">
																			...
																			<NuxtLink to="/doctor-profile">Dr. Darren Elder <span>Dental</span></NuxtLink>
																		</h2>
																	</td>
																...
																<tr>
																	<td>
																		<h2 class="table-avatar">
																			...
																			<NuxtLink to="/doctor-profile">Dr. Deborah Angel <span>Cardiology</span></NuxtLink>
																		</h2>
																	</td>
																...
																<tr>
																	<td>
																		<h2 class="table-avatar">
																			...
																			<NuxtLink to="/doctor-profile">Dr. Sofia Brient <span>Urology</span></NuxtLink>
																		</h2>
																	</td>
																...
																<tr>
																	<td>
																		<h2 class="table-avatar">
																			...
																			<NuxtLink to="/doctor-profile">Dr. Marvin Campbell <span>Ophthalmology</span></NuxtLink>
																		</h2>
																	</td>
																...
																<tr>
																	<td>
																		<h2 class="table-avatar">
																			...
																			<NuxtLink to="/doctor-profile">Dr. Katharine Berthold <span>Orthopaedics</span></NuxtLink>
																		</h2>
																	</td>
																...
																<tr>
																	<td>
																		<h2 class="table-avatar">
																			...
																			<NuxtLink to="/doctor-profile">Dr. Linda Tobin <span>Neurology</span></NuxtLink>
																		</h2>
																	</td>
																...
																<tr>
																	<td>
																		<h2 class="table-avatar">
																			...
																			<NuxtLink to="/doctor-profile">Dr. Paul Richard <span>Dermatology</span></NuxtLink>
																		</h2>
																	</td>
																...
																<tr>
																	<td>
																		<h2 class="table-avatar">
																			...
																			<NuxtLink to="/doctor-profile">Dr. John Gibbs <span>Dental</span></NuxtLink>
																		</h2>
																	</td>
																...
																<tr>
																	<td>
																		<h2 class="table-avatar">
																			...
																			<NuxtLink to="/doctor-profile">Dr. Olga Barlow  <span>Dental</span></NuxtLink>
																		</h2>
																	</td>
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			...
																			<NuxtLink to="/doctor-profile">Dr. Marvin Campbell <span>Dental</span></NuxtLink>
																		</h2>
																	</td>
																	<td class="text-end">
																		<div class="table-action">
													...
													<div class="table-responsive">
														<table class="table table-hover table-center mb-0">
															...
															<tbody>
																<tr>
																	<td>
																		<NuxtLink to="/invoice-view">#INV-0010</NuxtLink>
																	</td>
																	<td>
																		<h2 class="table-avatar">
																			<NuxtLink to="/doctor-profile" class="avatar avatar-sm me-2">
																			...
																			<NuxtLink to="/doctor-profile">Ruby Perrin <span>Dental</span></NuxtLink>
																		</h2>
																	</td>
																	<td>$450</td>
																	<td>14 Nov 2019</td>
																	<td class="text-end">
																		<div class="table-action">
																			<NuxtLink to="/invoice-view" class="btn btn-sm bg-info-light">
																				<i class="far fa-eye"></i> View
                                                                            </NuxtLink>
																			<a href="javascript:void(0);" class="btn btn-sm bg-primary-light">
																				<i class="fas fa-print"></i> Print
																...
																<tr>
																	<td>
																		<NuxtLink to="/invoice-view">#INV-0009</NuxtLink>
																	</td>
																	<td>
																		<h2 class="table-avatar">
																			<NuxtLink to="/doctor-profile" class="avatar avatar-sm me-2">
																...
																<tr>
																	<td>
																		<NuxtLink to="/invoice-view">#INV-0008</NuxtLink>
																	</td>
																	<td>
																		<h2 class="table-avatar">
																			<NuxtLink to="/doctor-profile" class="avatar avatar-sm me-2">
																...
																<tr>
																	<td>
																		<NuxtLink to="/invoice-view">#INV-0007</NuxtLink>
																	</td>
																	<td>
																		<h2 class="table-avatar">
																			<NuxtLink to="/doctor-profile" class="avatar avatar-sm me-2">
																...
																<tr>
																	<td>
																		<NuxtLink to="/invoice-view">#INV-0006</NuxtLink>
																	</td>
																	<td>
																		<h2 class="table-avatar">
																			<NuxtLink to="/doctor-profile" class="avatar avatar-sm me-2">
																...
																<tr>
																	<td>
																		<NuxtLink to="/invoice-view"">#INV-0005</NuxtLink>
																	</td>
																	<td>
																		<h2 class="table-avatar">
																			<NuxtLink to="/doctor-profile" class="avatar avatar-sm me-2">
																...
																<tr>
																	<td>
																		<NuxtLink to="/invoice-view">#INV-0004</NuxtLink>
																	</td>
																	<td>
																		<h2 class="table-avatar">
																			<NuxtLink to="/doctor-profile" class="avatar avatar-sm me-2">
																...
																<tr>
																	<td>
																		<NuxtLink to="/invoice-view">#INV-0003</NuxtLink>
																	</td>
																	<td>
																		<h2 class="table-avatar">
																			<NuxtLink to="/doctor-profile" class="avatar avatar-sm me-2">
																...
																<tr>
																	<td>
																		<NuxtLink to="/invoice-view">#INV-0002</NuxtLink>
																	</td>
																	<td>
																		<h2 class="table-avatar">
																			<NuxtLink to="/doctor-profile" class="avatar avatar-sm me-2">
																...
																<tr>
																	<td>
																		<NuxtLink to="/invoice-view">#INV-0001</NuxtLink>
																	</td>
																	<td>
																		<h2 class="table-avatar">
																			<NuxtLink to="/doctor-profile" class="avatar avatar-sm me-2">
																			...
																			<NuxtLink to="/doctor-profile">Dr. Olga Barlow <span>#0010</span></NuxtLink>
																		</h2>
																	</td>
																	<td>$550</td>
																	<td>5 Nov 2019</td>
    ...
    <script>
    export default {
        layout: 'withoutanimationpatient',
        mounted() {
        },
        computed: {
           currentPath() {
