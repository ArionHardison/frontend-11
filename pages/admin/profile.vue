                    ...
                    <div class="profile-info">
                        ...
                        <div class="profile-list">
                            <div class="profile-detail">
                                ...
                                <a href="javascript:void(0);" class="edit-pro"><edit-icon size="1.4x" class="custom-class"></edit-icon> Edit</a>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <ul class="social-icon">
                                        <li>
                                            <a href="javascript:void(0);"><twitter-icon size="1.4x" class="custom-class"></twitter-icon></a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);"> <facebook-icon size="1.4x" class="custom-class"></facebook-icon></a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);"><linkedin-icon size="1.4x" class="custom-class"></linkedin-icon></a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);"><instagram-icon size="1.4x" class="custom-class"></instagram-icon></a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);"><youtube-icon size="1.4x" class="custom-class"></youtube-icon></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
