            ...
            <div class="login-wrapper">
                <div class="loginbox email-confirm">
                    <div class="success-icon">
                        <check-circle-icon size="1.4x" class="custom-class"></check-circle-icon>
                    </div>
                    <h3>Success !</h3>
                    ...
                    <NuxtLink to="/admin/forgot-password" class="btn btn-primary"> <home-icon size="1.4x" class="custom-class"></home-icon> Back to Home</NuxtLink>
                </div>
            </div>
            <!-- /Restart Password -->
