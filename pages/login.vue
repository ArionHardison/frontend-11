                    ...
                    <div class="row align-items-center justify-content-center">
                        ...
                        <div class="col-md-12 col-lg-6 login-right">
                            ...
                            <form>
                                ...
                                <div class="text-end">
                                    <NuxtLink class="forgot-link" to="/forgot-password">Forgot Password ?</NuxtLink>
                                </div>
                                <NuxtLink to="/">
                                ...
                                <div class="text-center dont-have">Don’t have an account? <NuxtLink to="/register">Register</NuxtLink></div>
                            </form>
                        </div>
                    </div>
                </div>
