                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-hover table-center mb-0">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td>1</td>
                                                                    <td><NuxtLink to="/invoice-view">OD1236547890</NuxtLink></td>
                                                                ...
                                                                <tr>
                                                                    <td>2</td>
                                                                    <td><NuxtLink to="/invoice-view">OD1236547891</NuxtLink></td>
                                                                    <td>Medlife Medical</td>
                                                                ...
                                                                <tr>
                                                                    <td>3</td>
                                                                    <td><NuxtLink to="/invoice-view">OD1236547892</NuxtLink></td>
                                                                    <td>Medlife Medical</td>
                                                                ...
                                                                <tr>
                                                                    <td>4</td>
                                                                    <td><NuxtLink to="/invoice-view">OD1236547893</NuxtLink>></td>
                                                                ...
                                                                <tr>
                                                                    <td>5</td>
                                                                    <td><NuxtLink to="/invoice-view">OD1236547894</NuxtLink></td>
                                                                    <td>PharmaMed Medical</td>
                                                                ...
                                                                <tr>
                                                                    <td>6</td>
                                                                    <td><NuxtLink to="/invoice-view">OD1236547895</NuxtLink></td>
