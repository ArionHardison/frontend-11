<template>
    <div>
	<!-- Footer Five -->
    <footer class="footer footer-five" style="font-family: 'Inter', sans-serif !important;
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="footer-widget footer-about">
                            ...
                            <div class="footer-widget footer-menu footer-menu-five">
                                <ul>
                                    <li><a href="javascript:void(0);" target="_blank"><i class="fab fa-facebook"></i> Facebook</a>
                                    </li>
                                    <li><a href="javascript:void(0);" target="_blank"><i class="fab fa-twitter"></i> Twitter</a>
                                    </li>
                                    <li><a href="javascript:void(0);" target="_blank"><i class="fab fa-linkedin"></i> Linkedin</a>
                                    </li>
                                    <li><a href="javascript:void(0);" target="_blank"><i class="fab fa-instagram"></i> Instagram</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
